...
ProjectDatum.create!([
  {amount_raised: "340.0", visible: true, goal: "3500.0", category_id: 1, deadline: "2018-04-27", estimated_delivery_time: "2018-04-28", description: "This is the description of project number 1, it has to be at least of 50 characters", project_id: 1, website: "www.project1.com"},
  {amount_raised: "300.0", visible: true, goal: "4500.0", category_id: 2, deadline: "2018-04-28", estimated_delivery_time: "2018-04-29", description: "This is the description of project number 1, it has to be at least of 50 characters", project_id: 2, website: "www.project2.com"},
  {amount_raised: "0.0", visible: true, goal: "500.0", category_id: 3, deadline: "2018-05-05", estimated_delivery_time: "2018-08-03", description: "This is the description of project number 3, it has to be at least of 50 characters", project_id: 3, website: "www.project3.com"},
  {amount_raised: "10.0", visible: true, goal: "5000.0", category_id: 3, deadline: "2018-05-05", estimated_delivery_time: "2018-08-03", description: "This is the description of project number 3, it has to be at least of 50 characters", project_id: 3, website: "www.project3.com"},
  {amount_raised: "0.0", visible: true, goal: "20000.0", category_id: 4, deadline: "2018-05-05", estimated_delivery_time: "2018-08-03", description: "This is the description of project number 4, it has to be at least of 50 characters", project_id: 4, website: "www.project4.com"},
  {amount_raised: "0.0", visible: true, goal: "2000.0", category_id: 4, deadline: "2018-05-05", estimated_delivery_time: "2018-08-03", description: "This is the description of project number 5, it has to be at least of 50 characters", project_id: 5, website: "www.project5.com"}
])
Promise.create!([
